...
CREATE FUNCTION public.create_quote_final_and_update_quote_status(p_quote_id bigint, quote_final_no character varying, customer_id bigint, project_name character varying, start_date date, end_date date, quote_final_type character varying, work_location character varying, project_content character varying, total_man_month numeric, total_amount bigint, currency_code character varying, quote_final_validity character varying, condition_payment character varying, is_entrust boolean, person_in_charge character varying, attach_file text) RETURNS bigint
    ...
    AS $$
declare
	new_quote_final_id int8;
BEGIN
	insert into t_quote_final(quote_id,
	quote_final_no,
	customer_id,
	project_name,
	start_date,
	...
	total_amount,
	currency_code,
	quote_final_validity,
	condition_payment,
	is_entrust,
	person_in_charge,
	attach_file) 
	values(p_quote_id, quote_final_no, customer_id, project_name, start_date, end_date, 
			quote_final_type, work_location, project_content, total_man_month, total_amount, 
			currency_code, quote_final_validity, condition_payment, is_entrust, person_in_charge, attach_file) 
	returning quote_final_id into new_quote_final_id;
	
	update
		t_quote tq
	set
		quote_status = 'RAWTYPE005'
	where
		tq.quote_id = p_quote_id;

	return new_quote_final_id;
END;
$$;
...
CREATE TABLE public.m_code (
    code_id character varying(10) NOT NULL,
    code_name character varying(40),
    type_code character varying(10) NOT NULL,
    type_name character varying(40),
    sort_order integer,
    delete_flag character(1) DEFAULT 0 NOT NULL,
    create_user bigint,
...
CREATE TABLE public.t_acceptance_report (
    acceptance_report_id bigint NOT NULL,
    contract_id bigint NOT NULL,
    contract_payment_id bigint NOT NULL,
    acceptance_status character varying(10) DEFAULT 'ARS001'::character varying NOT NULL,
    acceptance_date date,
    actual_amount bigint,
    currency_code character varying(10),
    payment_method character varying(100),
    acceptance_remark character varying(256),
    create_user bigint,
    create_timestamp timestamp without time zone,
    update_user bigint,
    update_timestamp timestamp without time zone
...
CREATE TABLE public.t_approval_history (
    ...
    app_status character varying(10),
    app_content character varying(256),
    create_user bigint,
    create_timestamp timestamp without time zone,
    update_user bigint,
    update_timestamp timestamp without time zone
...
CREATE TABLE public.t_contract (
    contract_id bigint NOT NULL,
    quote_final_id bigint NOT NULL,
    contract_no character varying(30) NOT NULL,
    contract_type character varying(10) NOT NULL,
    contract_status character varying(10),
    person_in_charge character varying(100),
    sub_person_in_charge character varying(100),
    customer_in_charge character varying(100),
    contract_start_date date,
    contract_end_date date,
    man_month numeric(10,2),
    total_amount bigint,
    currency_code character varying(10),
    attach_file text,
    create_user bigint,
...
CREATE TABLE public.t_contract_payment (
    ...
    contract_payment_status character varying(20) DEFAULT 'CPS001'::character varying,
    man_month numeric(10,2),
    total_amount bigint,
    currency_code character varying(10),
    create_user bigint,
...
CREATE TABLE public.t_quote (
    ...
    quote_type character varying(10) NOT NULL,
    quote_no character varying(30) NOT NULL,
    customer_id bigint NOT NULL,
    project_no character varying(50),
    quote_status character varying(10),
    project_name character varying(100),
    project_content character varying(256),
    start_date date,
    end_date date,
    work_location character varying(256),
    total_man_month numeric(10,2),
    total_amount bigint,
    currency_code character varying(10),
    ...
    update_user bigint,
    update_timestamp timestamp without time zone,
    create_user_name character varying(50),
    user_data_id text
);
...
CREATE TABLE public.t_quote_final (
    quote_final_id bigint NOT NULL,
    quote_id bigint NOT NULL,
    quote_final_no character varying(30) NOT NULL,
    quote_final_type character varying(10) NOT NULL,
    customer_id bigint NOT NULL,
    project_name character varying(100),
    start_date date,
    end_date date,
    ...
    currency_code character varying(10),
    attach_file text,
    quote_final_validity character varying(100),
    condition_payment character varying(100),
    is_entrust boolean,
    person_in_charge character varying(100),
    create_user bigint,
    create_timestamp timestamp without time zone,
...
CREATE TABLE public.t_quote_payment (
    quote_payment_id bigint NOT NULL,
    quote_id bigint NOT NULL,
    quote_payment_date date,
    man_month numeric(10,2),
    total_amount bigint,
    currency_code character varying(10),
    create_user text,
    ...
    update_user text,
    update_timestamp timestamp without time zone,
    quote_payment_type character varying(1) DEFAULT '0'::character varying
);
...
ALTER TABLE ONLY public.m_code
    ADD CONSTRAINT m_code_pkc PRIMARY KEY (code_id, type_code);
...
ALTER TABLE ONLY public.t_acceptance_report
    ADD CONSTRAINT t_acceptance_report_pkc PRIMARY KEY (acceptance_report_id);
...
ALTER TABLE ONLY public.t_approval_history
    ADD CONSTRAINT t_approval_history_pkc PRIMARY KEY (app_history_id);
...
ALTER TABLE ONLY public.t_contract_payment
    ADD CONSTRAINT t_contract_payment_pkc PRIMARY KEY (contract_payment_id);
...
ALTER TABLE ONLY public.t_contract
    ADD CONSTRAINT t_contract_pkc PRIMARY KEY (contract_id);
...
ALTER TABLE ONLY public.t_customer
    ADD CONSTRAINT t_customer_pkc PRIMARY KEY (customer_id);
...
ALTER TABLE ONLY public.t_quote_file
    ADD CONSTRAINT t_quote_file_pkey PRIMARY KEY (quote_file_id);
...
ALTER TABLE ONLY public.t_quote_final
    ADD CONSTRAINT t_quote_final_pkc PRIMARY KEY (quote_final_id);
...
ALTER TABLE ONLY public.t_quote_payment
    ADD CONSTRAINT t_quote_payment_pkc PRIMARY KEY (quote_payment_id);
...
ALTER TABLE ONLY public.t_quote
    ADD CONSTRAINT t_quote_pkc PRIMARY KEY (quote_id);
